...
public class StackWalkerExtraction {
    ...
    @Benchmark
    public Object walk_StackFrame() throws Exception {
    ...
    @Benchmark
    public Object backtrace_toList_StackTraceElements() throws Exception {
        StackWalker sw = StackWalker.getInstance(Set.of(StackWalker.Option.RETAIN_CLASS_REFERENCE), depth);
    ...
    @Benchmark
    public Object backtrace_stream_StackTraceElements() throws Exception {
        StackWalker sw = StackWalker.getInstance(Set.of(StackWalker.Option.RETAIN_CLASS_REFERENCE), depth);

...
public class MyThreadLocal extends ThreadLocal<String> {
    ...
    /*
     * Verify that a remote protected method `superInit` can be accessed
     * by a nested class via an access bridge.
     */
    @Test
     ...
     * @see NestmateTest
     */
    MethodHandle remoteProtectedMethod() throws ReflectiveOperationException {
        return MethodHandles.lookup().findSpecial(ThreadLocal.class, "initialValue",
    ...
    static class Invoker {
        ...
        static MethodHandle remoteProtectedMethod() throws ReflectiveOperationException {

...
/**
 * {@code NewInvocationHandler} is an <i>invocation handler</i>
 ...
 * @since 16
 */
public interface NewInvocationHandler extends InvocationHandler {
    /**
     * {@inheritDoc}
     */
     ...
     * associated with.
     *
     * @param   invoker default method invoker
    ...
    /**
     * {@code DefaultMethodInvoker} supports the invocation of default methods
     * declared in a proxy interface or inherited from its superinterface directly
     * or indirectly.
     */
    public final class DefaultMethodInvoker {
         ...
         * @throws IllegalArgumentException if any of the following conditions is {@code true}:
         *         <ul>
         *         <li>{@code proxy} is not the proxy instance being invoked; or</li>
         *         <li>the given {@code method} is not a default method declared
         *             in a proxy interface of the proxy class and not inherited from
         *             any of its superinterfaces; or</li>
         *         <li>the given {@code method} is overridden directly or indirectly by
        ...
        public final Object invoke(Object proxy, Method method, Object... args)
            ...
            if (this.proxy != proxy) {
                throw new IllegalArgumentException("'proxy' is not this invoker's proxy instance");
            }
        ...
        final Object proxy;
        private DefaultMethodInvoker(Object proxy) {
            this.proxy = proxy;
        }
         ...
         */
        MethodHandles.Lookup proxyClassLookup(MethodHandles.Lookup caller) {
            return AccessController.doPrivileged(new PrivilegedAction<>() {
                @Override
                public MethodHandles.Lookup run() {
                    try {
                        Method m = proxy.getClass().getDeclaredMethod("proxyClassLookup", MethodHandles.Lookup.class);
        ...
        static DefaultMethodInvoker getInvoker(Object proxy, InvocationHandler ih) {
            // verify that the object is actually a proxy instance
            Class<?> proxyClass = proxy.getClass();
            if (!Proxy.isProxyClass(proxyClass)) {
                throw new IllegalArgumentException("'proxy' is not a proxy instance");
            ...
            if (ih != ((Proxy) proxy).h) {
                throw new IllegalArgumentException("ih is not proxy's invocation handler");
            }
            return new DefaultMethodInvoker(proxy);
        }
    }
}
